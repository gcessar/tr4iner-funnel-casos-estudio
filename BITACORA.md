...
- Handoff: `AGENTS.md` actualizado con archivos, fuentes, rutas y contratos actuales. Las entradas locales anteriores son historial de iteración; esta entrada describe el resultado aprobado. Preview, integración y evidencia de producción se registrarán al completar el despliegue.
